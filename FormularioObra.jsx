      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
        ...
        <div className="lg:col-span-2 space-y-6 bg-[#0a0a0f] border border-[#CC0000]/20 p-8 rounded-2xl shadow-[0_0_30px_rgba(204,0,0,0.05)] relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div><label className="block text-[#CC0000] text-xs font-black mb-3 uppercase tracking-widest" style={{ fontFamily: "'Orbitron', sans-serif" }}>Tipo</label><select className="w-full bg-[#050508] border border-gray-800 rounded-xl p-4 text-white outline-none focus:border-[#CC0000] transition-all font-bold" onChange={e => setFormData({...formData, tipo: e.target.value})}><option>Manga</option><option>Manhwa</option><option>Manhua</option><option>Comic</option><option>Novel</option></select></div>
